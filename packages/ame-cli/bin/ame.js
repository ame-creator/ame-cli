...
checkNodeVersion(requiredVersion, 'ame-cli')
...
program
  ...
  .description('create a new component powered by ame-cli-service')
  .action((name, cmd) => {
...
program.on('--help', () => {
  console.log()
  console.log(`  Run ${chalk.cyan(`ame <command> --help`)} for detailed usage of given command.`)
  console.log()
})
